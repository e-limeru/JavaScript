...
function haveFood(unit) {
    ...
    if (unit_classes.includes('food-unit')) {
        ...
        result.innerHTML = "Ваш счет: "+score.toString();
    ...
    while (!obstacleCreated) { 
        ...
        if (!obstacle_cell_classes.includes('snake-unit')) {
            ...
            if (obstacleCreated) {
                ...
                //setTimeout(clearObstacle, 5000);
            }
        }
    }
}

function clearObstacle(unit) {
    obstacle = document.getElementsByClassName('obstacle-unit');
